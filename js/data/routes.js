  ...
  const regionSpecs = [
    ...
    },
    {
      ...
      routes: [
        ...
        ["chiayi-route-166", "縣道 166 瑞里線", "山岳", 78.4, 1331, 5, ["山谷", "長距離"]]
      ]
    },
    {
      id: "tainan",
      ...
      routes: [
        ["tainan-route-175", "175 東山咖啡公路", "丘陵", 60.9, 1121, 3, ["咖啡", "淺山"]],
    ...
    },
    {
      ...
      routes: [
        ["kaohsiung-qimei", "旗山美濃田園線", "平原", 55.9, 291, 2, ["田園", "補給便利"]],
        ["kaohsiung-jiaxian-liugui", "甲仙六龜山谷", "山岳", 103.7, 956, 4, ["河谷", "長距離"]],
