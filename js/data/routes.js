  ...
  const regionSpecs = [
    {
      ...
      routes: [
        ["keelung-harbor-coast", "基隆港濱海晨騎", "海岸", 19.9, 233, 2, ["港灣", "海風"]],
        ["keelung-nuannuan-hills", "暖暖東勢坑丘陵", "丘陵", 23.8, 345, 3, ["林道", "短坡"]],
        ["keelung-waimushan-wanli", "外木山至萬里海線", "海岸", 29.1, 402, 3, ["海景", "補給便利"]]
      ]
    },
    {
      id: "taipei",
      ...
      routes: [
        ...
        ["taipei-lengshuikeng", "冷水坑硫磺線", "山岳", 32.1, 1034, 4, ["火山地景", "霧"]]
      ]
    },
    {
      id: "new-taipei",
    ...
    },
    {
      ...
      routes: [
        ...
        ["taoyuan-shimen-loop", "石門水庫環湖", "丘陵", 54.9, 1003, 3, ["水庫", "補給便利"]]
      ]
    },
    {
      id: "hsinchu-city",
      ...
      routes: [
        ...
        ["hsinchu-city-nanliao-baoshan", "南寮寶山丘陵", "丘陵", 44.8, 479, 3, ["海風", "水庫"]]
      ]
    },
    {
      id: "hsinchu-county",
      ...
      routes: [
        ...
        ["hsinchu-county-yulao", "宇老觀景台", "山岳", 69.2, 1459, 5, ["高山", "長爬坡"]],
        ["hsinchu-county-smangus", "司馬庫斯部落挑戰", "山岳", 111.4, 3934, 5, ["部落", "極限"]]
      ]
    },
    {
      id: "miaoli",
      ...
      routes: [
        ["miaoli-xianshan", "仙山靈洞宮", "山岳", 52.5, 1409, 4, ["陡坡", "山城"]],
    ...
    },
    {
      ...
      routes: [
        ...
        ["changhua-baguashan", "八卦山茶園迴圈", "丘陵", 60.5, 979, 2, ["茶園", "短程"]],
        ["changhua-coast", "彰濱海岸風車線", "海岸", 69, 72, 2, ["風車", "強風"]]
      ]
    },
    {
      id: "nantou",
      ...
      routes: [
        ...
        ["nantou-shanlinxi", "杉林溪竹林線", "山岳", 80.8, 1974, 5, ["竹林", "長爬坡"]]
      ]
    },
    {
      id: "yunlin",
      ...
      routes: [
        ...
        ["yunlin-kouhu-coast", "口湖濱海濕地", "海岸", 46.4, 50, 1, ["濕地", "平路"]]
      ]
    },
    {
      id: "chiayi-city",
  ...
  regionSpecs.forEach(function (region, regionIndex) {
    region.routes.forEach(function (seed, routeIndex) {
      ...
      routes.push({
        ...
        cautions: routeCautions[id] || (id === "hsinchu-county-smangus"
          ? [
