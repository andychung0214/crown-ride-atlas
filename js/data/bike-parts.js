...
(function (root, factory) {
  ...
  const CONTENT_BY_ID = {
    ...
    "brake-caliper": {
      purpose: "碟煞卡鉗以活塞推動來令片夾住碟盤；輪圈煞車則由拉臂帶動煞車皮夾住輪圈。",
      materials: "碟煞卡鉗包含鋁合金本體、活塞、密封件與來令片；輪圈煞車包含拉臂、樞軸與煞車皮。",
      adjustment: "碟煞需設定卡鉗置中、來令片間隙並依程序排氣；輪圈煞車需調整拉臂置中、煞車皮角度與拉線張力。",
      maintenance: "碟煞應保持活塞、密封與來令片潔淨並檢查漏油；輪圈煞車需清潔樞軸並查看拉臂回位與煞車皮磨耗。",
      warningSigns: "煞車失效、漏油、拉桿觸底、卡鉗鬆動或摩擦片受污染應停止騎乘。",
      relatedParts: ["disc-rotor", "shift-brake-lever", "rim"],
      workshopAdvice: "碟煞來令片與輪圈煞車皮都依原廠規格量測；先辨識系統類型，再處理油污染、拉線或液壓問題。"
    }
  };
