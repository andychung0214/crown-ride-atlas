...
(function (root, factory) {
  ...
  const CONTENT_BY_ID = {
    ...
    "rim": {
      ...
      workshopAdvice: "輪圈煞車用碳纖維輪圈需使用相容煞車皮；碟煞輪圈不用輪圈煞車皮。煞車面磨耗與胎壓上限依輪圈原廠規格。"
    },
    "tire": {
    ...
    "spoke": {
      ...
      adjustment: "使用輻條張力計及校輪台，讓同側輻條的相對張力盡量均勻；受花鼓法蘭偏置影響，左右張力不一定相同，並須同時控制偏擺、圓度與置中。",
    ...
    "brake-caliper": {
      purpose: "油壓碟煞以管路壓力推動卡鉗活塞，機械碟煞以拉線帶動卡鉗作動臂；兩者都使來令片夾住碟盤。輪圈煞車則以拉臂讓煞車皮夾住輪圈煞車面。",
      materials: "油壓碟煞卡鉗包含鋁合金本體、活塞、密封件與油管；機械碟煞另有作動臂、凸輪及拉線固定件；輪圈煞車包含拉臂、樞軸與煞車皮。",
      adjustment: "油壓碟煞需設定卡鉗置中並依原廠程序排氣；機械碟煞需調整卡鉗置中、拉線張力與來令片間隙；輪圈煞車需調整拉臂置中、煞車皮位置及拉線張力。",
      maintenance: "油壓碟煞應檢查漏油並保持活塞與來令片潔淨；機械碟煞應檢查拉線、作動臂與來令片磨耗；輪圈煞車需清潔樞軸並查看拉臂回位及煞車皮磨耗。",
      warningSigns: "煞車失效、油壓系統漏油、拉線磨損、拉桿觸底、卡鉗鬆動或摩擦片受污染時應停止騎乘。",
      relatedParts: ["disc-rotor", "shift-brake-lever", "rim"],
      workshopAdvice: "輪圈煞車皮僅適用於輪圈煞車，碟煞須使用相容來令片；先辨識油壓或機械作動方式，機械碟煞不進行油壓排氣。"
    }
  };
